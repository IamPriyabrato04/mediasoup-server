...
import { Consumer, Producer, Router, WebRtcTransport, WebRtcTransportOptions, Worker } from 'mediasoup/types';
...
export function handleSocketConnection(socket: WebSocket, worker: Worker) {
